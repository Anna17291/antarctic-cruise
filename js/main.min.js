...
/* harmony import */ var _modules_open_close_modal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/open-close-modal.js */ "./js/modules/open-close-modal.js");




Object(_modules_open_close_modal_js__WEBPACK_IMPORTED_MODULE_3__["openCloseModal"])();
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ "./js/modules/utils.js");

var modal = document.querySelector('.modal-container');
var pageBody = document.querySelector('body');
var mainLogo = document.querySelector('.header-logo');
var itemFirst = document.querySelector('.modal-item--first');
var itemSecond = document.querySelector('.modal-item--second');
var itemThird = document.querySelector('.modal-item--third');
var itemFourth = document.querySelector('.modal-item--fourth');
var openCloseModal = function openCloseModal() {
  var modalCloseButton = document.querySelector('.modal-page__close-button');
  var modalOpenButton = document.querySelector('.navigation-toggle');
  var modalContainer = document.querySelector('.modal-page');
  ...
  var onModalFormEscDown = function onModalFormEscDown(evt) {
    if (Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
      evt.preventDefault();
      closeModalWindow();
    }
  ...
  modal.addEventListener('click', function (e) {
    var withinBoundaries = e.composedPath().includes(modalContainer);
    if (!withinBoundaries) {
      closeModal();
    }
  });
